...
% field ('auto_freq') is needed when the system exhibits autonomous frequency(s). Apart from that, there are three optional ...
...
%
% Next, there is the "options.opt_sol" structure. There are three mandatory fields and a total of four optional-needed fields, ...
% which we all need for mixed systems exhibiting one autonomous and one non-autonomous frequency. Apart from that, there are three ...
...
% field ('non_auto_freq') is needed when the system exhibits autonomous frequency(s). Apart from that, there are three optional ...
% fields, but we use their default values and therefore do not set them.
options.opt_sol = costaropts('sol_type','quasiperiodic','approx_method','fourier-galerkin','cont','on','stability','on', ...
