...
%                                      -> Allowed values: Positive integer
%                                      -> Default value:  Inf
%                  - 'phasecond':      Defines the type of phase condition used for calculating solutions of systems exhibiting one ...
%                                      ore two autonomous frequencies. 'int_poincare' phase condition is recommended. For two ...
%                                      autonomous frequencies, only "int_poincare" is possible. 'phasecond' is not allowed when ...
%                                      dealing with full non-autonomous systems.
%                                      -> Allowed values: 'poincare', 'int_poincare'
%                                      -> Default value:  'int_poincare'
% NOTE: It is not necessary to set 'error_control', 'ec_iter_max' and 'phasecond' since the default values are used. However, it ...
...
%                                      -> Allowed values: 'poincare', 'int_poincare'
%                                      -> Default value:  'int_poincare'
% NOTE: It is not necessary to set 'n_FFT', 'error_control', 'ec_iter_max' and 'phasecond' since the default values are used. ...
...
%                                      -> Allowed values: 'poincare', 'int_poincare'
%                                      -> Default value:  'int_poincare'
% NOTE: It is not necessary to set 'n_FFT', 'error_control', 'error_limit', 'ec_iter_max' and 'phasecond' since the default values ...
