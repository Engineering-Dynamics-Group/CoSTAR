...
options.opt_sol = costaropts('sol_type','quasiperiodic','approx_method','finite-difference','cont','on','stability','on', ...
...
%
options.opt_cont = costaropts('mu_limit',mu_limit,'step_width',0.5,'predictor','secant');
...
%                   - 'predictor':   Defines the method to calculate the predictor point (default: tangent). When calculating ...
...
% and "options.opt_stability", type "costarhelp.<name_of_options_structure>('QPS','FDM')" ("QPS": Quasi-Periodic Solution).
...
options_kappa.opt_sol = costaropts('sol_type','quasiperiodic','approx_method','finite-difference','cont','on','stability','on', ...
...
options_kappa.opt_cont = costaropts('mu_limit',mu_limit_kappa,'step_width',0.2,'predictor','secant');
options.opt_stability = costaropts('n_char_st',30);
%
...
%
options.opt_cont = costaropts('mu_limit',mu_limit,'step_width',0.5,'predictor','secant','direction',-1);
% Mandatory fields: - 'mu_limit':    Sets the limits of the continuation. For this purpose, we defined the "mu_limit" variable.
%                                    -> Allowed values: [1x2] double array of increasing numerical values
% Optional fields:  - 'step_width':  Defines the initial step width (default: 0.1). The step width will be altered in the range ...
%                                    of step_width*[0.2, 5]. It is set here in order to reduce the numerical effort. Step control ...
...
%       example above.
%
options.opt_cont = costaropts('mu_limit',mu_limit,'step_width',1.5,'step_control','off','predictor','secant');
% Mandatory fields: - 'mu_limit':      Sets the limits of the continuation. For this purpose, we defined the "mu_limit" variable.
%                                      -> Allowed values: [1x2] double array of increasing numerical values
% Optional fields:  - 'step_width':    Defines the (initial) step width (default: 0.1). The step width will be altered in the range ...
%                                      of step_width*[0.2, 5].
