...
%
% In this tutorial, we will look at how to compute quasi-periodic solutions using the quasi-periodic Shooting Method (SHM) to ...           
% approximate the solution. We will learn how to set up CoSTAR and how to correctly define all the required settings on the basis ...
...
% defines a curve in (n+1)-dimensional space (n depends on the dimension of the system as well as the discretization). Hence, a ...
...
% instable solutions are shown in red (attention: if the solution stability is not calculated, the curve is depicted in blue as well!).
%
...
opt_solplot = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',40,'index',[10,100]);
...
% which defines a curve in (n+2)-dimensional space (n depends on the dimension of the system as well as the discretization). Hence, ...
...
% In order to plot the hyper-time surfaces Z_i(theta_1,theta_2,mu) (torus function components), we need to call the "solplot" ...
% function. Similar to the "costar" function, solplot expects a structure that defines all required options for the plot.
opt_solplot = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',25,'index',[5,30]);
% Mandatory fields: - 'zaxis':       Defines what is plotted on the vertical axis. "@(z) z(:,:,1)" plots the first component (i = 1) ...
%                                    of the torus function against the hyper-time domain [0, 2*pi]^2.
%                   - 'space':       Specifies the "domain" of the plot. 'hypertime' plots the hyper-time surfaces of the solution.
% Optional fields:  - 'resolution':  Sets the number of points for the plot in each theta-direction.
...
% a curve in (n+3)-dimensional space (n depends on the dimension of the system as well as the discretization). Hence, a solution ...
...
% In order to plot the hyper-time surfaces Z_i(theta_1,theta_2,mu) (torus function components), we need to call the "solplot" ...
% function. Similar to the "costar" function, solplot expects a structure that defines all required options for the plot.
opt_solplot = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',50,'index',[5,30]);
% Mandatory fields: - 'zaxis':       Defines what is plotted on the vertical axis. "@(z) z(:,:,1)" plots the first component (i = 1) ...
%                                    of the torus function against the hyper-time domain [0, 2*pi]^2.
%                   - 'space':       Specifies the "domain" of the plot. 'hypertime' plots the hyper-time surfaces of the solution.
% Optional fields:  - 'resolution':  Sets the number of points for the plot in each theta-direction.
