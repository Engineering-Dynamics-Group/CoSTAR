...
% defines a curve in (n+1)-dimensional space (n depends on the dimension of the system as well as the finite difference discretization). 
...
% towards z0. If z_IV is too far away from z0 and/or the discretization is too coarse, it may happen that fsolve does not converge ...
...
%                                     -> Default value:  100
%                  - 'scheme':        This field refers to the discretization scheme used to approximate the derivation dz/dtau. ...
...
% difference discretization). Hence, a solution z(tau) of (4) is also denoted as a "point on the curve" in the following explanations. ...
