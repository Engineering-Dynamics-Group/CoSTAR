...
%
% The purpose of the examples is to provide sample code to show how a certain CoSTAR module can be used.
% 
%
% The following code is identical to the code of the Postprocessing - contplot - Tutorial.
% However, most of the explanations have been omitted in order to keep this as short as possible.
