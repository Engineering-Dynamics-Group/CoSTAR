...
%
% This example covers the computation of quasi-periodic solutions using the Fourier-Galerkin Method (associated tutorial: Tutorial_QPS_FGM).
...
% Postprocessing
solplot_options_1 = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',30,'index',[25,200]);     % "options" structure for the solplot function
...
% Postprocessing
solplot_options_2 = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',30,'index',[5,50]);   % "options" structure for the solplot function
...
% Postprocessing
solplot_options_3 = costaropts('zaxis',@(z) z(:,:,1),'space','hypertime','resolution',40,'index',[5,55]);   % "options" structure for the solplot function
