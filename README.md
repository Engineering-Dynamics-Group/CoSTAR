...
```
cd existing_repo
git remote add origin https://gitlab.uni-kassel.de/uk007705/costar.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.uni-kassel.de/uk007705/costar/-/settings/integrations)
