...
function help_struct = s_help_opt_cont()
    ...
    help_struct.optional.predictor.value = '''tangent'', ''secant'', \n ''parable'' or ''cubic'' \n Default: ''tangent''';
    help_struct.optional.predictor.text  = ['Method for computing the predictor point and direction vector, which is a unit vector from latest solution point to predictor point.\n' ...
   ...
   help_struct.optional.step_control.text  = ['Defines the algorithm to adapt the step width during the continuation in order to achieve a high resolution in complex curve sections and a low resolution in less complex sections to save numerical cost. \n' ...
    ...
    help_struct.optional.step_control_param.value    = '[1x2] positive double array';
