...
function help_struct = s_help_opt_cont()
   ...
   help_struct.optional.step_control.text  = ['Defines the algorithm to adapt the step width during the continuation in order to achieve a high resolution in complex curve sections and a low resolution in less complex sections to save numerical cost. \n' ...
    ...
    help_struct.optional.step_control_param.text     = ['Array defining parameters used by the step control. Values depend on the chosen step control method. \n' ...
                                                       'In general: it_nom determines the desired number of corrector iterations and it_max determines the maximal allowed number of corrector iterations. \n' ...
                                                       '--> ''angle'': [it_max, alpha_nom], where alpha_nom determines the desired angle. \n' ...
                                                       '    Default: [3, 3/180*pi] \n' ...
                                                       '--> ''corrector_iterations'': [it_nom, alpha_max], where alpha_max determines the maximal allowed angle. \n' ...
                                                       '                   Default: [3, 3/180*pi] \n' ...
                                                       '--> ''norm_corrector'': [it_max, norm_corr_nom], where norm_corr_nom determines the desired length of the correction vector. \n' ...
                                                       '             Default: [3, 0.0025] \n' ...
                                                       '--> ''combination'': [it_nom, alpha_nom], where alpha_nom determines the desired angle. \n' ...
                                                       '          Default: [3, 3/180*pi] \n' ...
                                                       '--> ''pid'':  [it_max, tol, kP, kI, kD] (see method step_control for details). \n ' ...
                                                       '  Default: [3, 0.1, 0.075, 0.175, 0.01]'];
