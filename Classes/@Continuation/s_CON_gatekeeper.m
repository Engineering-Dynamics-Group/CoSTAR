...
function s_CON_gatekeeper(GC,opt_cont)
    ...
    opt_cont_allowed_fieldnames    = {'step_width','max_cont_step','pred','subspace','mu_limit','direction','step_control','plot','step_width_limit','step_control_param'}; %Allowed fieldnames in the opt_cont structure
