...
function help_struct = s_help_contplot()
    ...
    help_struct.optional.figure.text  = 'Defines the figure in which to plot the curve. Can be used to plot multiple continuation curves into the same figure. \n When this field is empty, a new figure is opened.';
    ...
    help_struct.optional.linestyle.text  = 'Defines the linestyle of the  plotted curve.';
