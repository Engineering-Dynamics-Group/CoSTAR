...
function help_struct = s_help_solget()
    ...
    help_struct.mandatory.eval.text  = ['Defines the evaluation of the solution, i.e. the returned quantity. \n' ...
                                         ...
                                         '--> function handle: The output of the function handle is returned. The maximum possible output size is equal to the input array size. The array type of the input argument depends on solution type and solution space:\n' ...
