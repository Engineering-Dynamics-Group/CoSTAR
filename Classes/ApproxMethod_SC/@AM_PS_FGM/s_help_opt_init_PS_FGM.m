...
function help_struct = s_help_opt_init_PS_FGM()


    help_struct.info = 'opt_init --- periodic solution --- Fourier-Galerkin method \n !!! There are two possibilities to define initial values !!! ';
    ...
    help_struct.mandatory.hmatrix.value        = '[1 x n_hh] array  \n e.g., [0,1,3,7,2,5,11,9].';
    help_struct.mandatory.hmatrix.text         = ['Defines the harmonics to be used in the Fourier series. hmatrix is mandatory for BOTH the first and second possiblity of defining initial values. hmatrix must at least contain the harmonics [0,1]. The ordering of the harmonics is arbitrary, but must correspond' ...
