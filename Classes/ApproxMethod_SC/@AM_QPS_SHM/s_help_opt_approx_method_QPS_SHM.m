...
function help_struct = s_help_opt_approx_method_QPS_SHM()
    ...
    help_struct.optional.n_char.text             = 'Defines the number of characteristics, which are ''shot'' over the manifold in order to approximate it. More characteristics improve the resolution and lead to higher numerical cost. Use a higher number for complex manifolds.';
