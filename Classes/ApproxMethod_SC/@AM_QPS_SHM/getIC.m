...
function IC = getIC(obj,y,DYN,n_char_st)                                            
    ...
    theta_2 = linspace(0,2*pi*(1-1/(n_char+1)),n_char);                 % theta_2 values of the computed solution
    ...
    % Evaluation
    theta_2_eval = linspace(0,2*pi*(1-1/(n_char_st+1)),n_char_st);      % theta_2 values for the new number of characteristics n_char_st
