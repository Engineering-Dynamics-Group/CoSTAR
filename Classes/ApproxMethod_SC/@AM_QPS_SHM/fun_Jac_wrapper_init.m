...
%       subspace constraint
%
function [f,J] = fun_Jac_wrapper_init(obj,y,y0,DYN)
...
[deltaF,~] =  obj.res(y+dy,DYN);                                            % Calulate residual of Quasi-periodic shooting for perturbed bifurcation parameter
