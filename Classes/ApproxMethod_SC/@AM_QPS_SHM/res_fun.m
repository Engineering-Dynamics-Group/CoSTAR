...
% "SpecifyObjectiveGradient" of fsolve
%
%@obj:  ApproximationMethod subclass object
%@y:    solution curve vector (possibly containing auto frequency)
%@y:    initial solution curve vector (possibly containing auto frequency)
...
delta_gp =  obj.res(y+dy);                                                  % Calculate residual of Quasi-periodic shooting for perturbed bifurcation parameter in positiv direction
delta_gm =  obj.res(y-dy);                                                  % Calculate residual of Quasi-periodic shooting for perturbed bifurcation parameter in negativ direction
J = [[dg,(delta_gp-delta_gm)./(2.*dmu)];CON.d_sub_con(y,CON)];              % Calculate Jacobian for initial solution of quasi-periodic shooting
