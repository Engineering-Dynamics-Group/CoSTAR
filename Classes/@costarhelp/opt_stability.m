...
function opt_stability(varargin)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    default_text = [...
    '-------------------------------------------------------------\n',...
    '--------------- CoSTAR Help for opt_stability ---------------\n',...
    '-------------------------------------------------------------\n',...
    'The opt_stability costaropts struct is used for defining \n',...
    'options specific for the stability computation of       \n',...
     strjoin(costarhelp.alternative_solution_type,' or '),' solutions.\n' ...
     '\n' ...
     '------------------------------\n' ...
     '\n'];
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [help_method_name,base_method_names] = costarhelp.s_call_for_help('opt_stability',costarhelp.key_words_stability,costarhelp.alternative_words_stability,costarhelp.key_words_solution_type,costarhelp.alternative_solution_type,varargin);
    ...
    switch size(help_method_name,1)
        ...
        case 0      % This case should not exist
            ...
            fprintf(append('Key word group 2: ',strjoin(costarhelp.key_words_stability,', '),' - or alternatively: ', strjoin(costarhelp.alternative_words_stability,', '),'.\n'));
            fprintf('\n');
            fprintf('Example: --> costarhelp.opt_stability("PS","shooting") \n');
            fprintf('\n');
            fprintf('-------------------------------------------------------------\n');
            fprintf('\n\n\n');
        ...
        otherwise   % More than one specific help file was found. Hyperlinks to the found help files are displayed.
            ...
            fprintf(['There are multiple help files for your help request for \n' ...
                     'opt_stability. Choose one of the following options by \n' ...
