...
function opt_approx_method(varargin)

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    default_text = [...
    '-------------------------------------------------------------\n',...
    '------------- CoSTAR Help for opt_approx_method -------------\n',...
    '-------------------------------------------------------------\n',...
    'The opt_approx_method costaropts struct is used for defining \n',...
    'options specific for one of the following approximation methods: \n',...
    ...
    [help_method_name,base_method_names] = costarhelp.s_call_for_help('opt_approx_method',costarhelp.key_words_method,costarhelp.alternative_method,costarhelp.key_words_solution_type,costarhelp.alternative_solution_type,varargin);
    ...
    switch size(help_method_name,1)
        ...
        case 0      % This case should not exist
            ...
            fprintf('\n');
            fprintf('Example: --> costarhelp.opt_approx_method("PS","fourier-galerkin") \n');
            fprintf('\n');
            fprintf('-------------------------------------------------------------\n');
            fprintf('\n\n\n');
        ...
        otherwise   % More than one specific help file was found. Hyperlinks to the found help files are displayed.
            ...
            fprintf(['There are multiple help files for your help request for \n' ...
                     'opt_approx_method. Choose one of the following options by \n' ...
