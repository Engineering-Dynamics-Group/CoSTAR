%This function returns the absolute value -1  of the given Floquet multipliers. This is a universal function for usage in superclass methods
%
%@obj:              Stability subclass ST_PS_SHM object
%@DYN:              DynamicalSystem object
%@multipliers:      Floquet of the current solution point       
%
