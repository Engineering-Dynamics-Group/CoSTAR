...
classdef ST_PS_SHM < Stability
    ...
    properties
        ...
        fsolve_opts = optimoptions('fsolve','Display','none','MaxIter',1e3,'UseParallel',false,'SpecifyObjectiveGradient',true);    % Options for fsolve to solve corrector-equation
