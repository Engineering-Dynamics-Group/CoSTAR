...
%the (Lyapunov) stability of equilibria
    ...
    classdef ST_EQ < Stability
        ...
        properties
            ...
            msg_label = { 'This is a fold,',...                                                             % The last entry is a safety measure, for the case when a bifurcation
                          'This is a Hopf bifurcation.',...                                                 % has been detected (due to a change in the number of unstable multipliers),
                          'This is a pitchfork or transcritical bifurcation.',...                           % but no test function was active.
                          'A bifurcation has occurred for which a test function does not yet exist.'};      
