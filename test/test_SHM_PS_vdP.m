...
options.opt_sol  = costaropts('stability','off','cont','off','auto_freq',auto_freq,'sol_type','periodic','approx_method','shm','act_param',active_parameter,'save','on');    % Properties of the solution
...
%% Properties
options.system   = costaropts('order',1,'rhs',Fcn,'param',param,'dim',2);                                               % Properties of the system
options.opt_sol  = costaropts('stability','on','cont','on','auto_freq',auto_freq,'sol_type','periodic','approx_method','shm','act_param',active_parameter,'save','on');     % Properties of the solution
