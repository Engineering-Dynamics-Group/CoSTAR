...
options.opt_cont = costaropts('step_control','on','direction',1,'predictor','tangent','subspace','pseudo-arc','mu_limit',mu_limit,'step_width',0.1,'max_cont_step',1e4);                                                             %Properties for continuation
