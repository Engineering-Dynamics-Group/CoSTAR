...
options.opt_sol  = costaropts('stability','off','cont','on','non_auto_freq',non_auto_freq,'sol_type','quasiperiodic','approx_method','fourier-galerkin','act_param',active_parameter);  %Properties of the solution
...
options.opt_cont = costaropts('step_control','angle','pred','parable','mu_limit',mu_limit,'direction',-1,'display','step_control_info');   %Properties for continuation
